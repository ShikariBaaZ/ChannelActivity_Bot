...
log = logging.getLogger("ChannelActivity")
log.info("\n\nStarting...\n")
...
**Hey Dear, I'm a Channel Activity bot, mainly focused on working with the new [admin approval invite links](https://t.me/telegram/153).**

**__I am able to__**:
- __Auto approve new join requests.__
- __Auto Decline New Join Requests.__

`If you Dont Know How to use Me? Then , Click the Following Button !`"""
start_buttons = [
    [Button.inline("How to use me ❓", data="helper")],
    [Button.url("Updates", "https://t.me/Lawless_Updates")],
]
...
async def helper(event):
    await event.edit(
        '**Usage instructions.**\n\n💐Add me to your Channel, as an ADMIN of Channel, with "Add Users" permission, and forward me a message from that chat to set me up!\n\nTo approve members who are already in waiting list, upgrade to premium for 3$ per month! Contact ❤️ @The_Shikarii ❤️ if you are interested.',
